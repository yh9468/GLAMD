...
from .base_dense_head_mine import BaseDenseHeadMine
from .dense_test_mixins import BBoxTestMixin


@HEADS.register_module()
class AnchorHead_Attention(BaseDenseHeadMine, BBoxTestMixin):
    ...
    def __init__(self,
                 ...
                 train_cfg=None,
                 test_cfg=None):
        super(AnchorHead_Attention, self).__init__()
    ...
    def loss_single(self, cls_score, bbox_pred, anchors, labels, label_weights,
        ...
        return loss_cls, loss_bbox, decoded_bbox_pred
    ...
    def loss(self,
        ...
        # gt_bboxes = (B x tensor(object_num x 4))
        # anchor_list = (B x stage x tensor(anchor_num x 4))
        # all_anchor_list = (Stage x tensor(Batch x anchor_num x 4))
        losses_cls, losses_bbox, decoded_bbox_pred = multi_apply(
            self.loss_single,
            cls_scores,
            bbox_preds,
            all_anchor_list,
        ...
        return dict(loss_cls=losses_cls, loss_bbox=losses_bbox), decoded_bbox_pred
