...
from .anchor_head_mine import AnchorHead_Attention


@HEADS.register_module()
class RPNHead(AnchorHead_Attention):
    """RPN head.
    ...
    def loss(self,
        ...
        """
        losses, decoded_bbox = super(RPNHead, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
        ...
        return dict(
            loss_rpn_cls=losses['loss_cls'], loss_rpn_bbox=losses['loss_bbox']), decoded_bbox
